...
/**
 *
 * @package App\Clients\LangCorrect
 */
class LanguageTypos
{
    /**
     ...
     * @var string[]
     */
    private static ?array $similarRuToEn = [
        //ru => en        //RU => EN
        "\u{0430}" => 'a', "\u{0410}" => 'A',
        /**/               "\u{0412}" => 'B',
        "\u{0435}" => 'e', "\u{0415}" => 'E',
     ...
     * @var string[]
     */
    private static ?array $similarEnToRu = null;

    /**
     * @var string[]
     */
    private static ?array $similarAll = null;
     ...
     * @var string[]
     */
    private static ?array $keyboardEnToRu = [
        //[CapsLock] off
        '`' => 'ё',
        'q' => 'й',
        'w' => 'ц',
     ...
     * @var string[]
     */
    private static ?array $keyboardRuToEn = null;
